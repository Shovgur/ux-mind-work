...
const DressPage = ({ sort, setSort }: FilterProps) => {
  ...
  return (
    <div className={styles.dresspage__container}>
      ...
      <div className={styles.dresspage__filter_card_container}>
        ...
        <div className={styles.dresspage__container_cardlist}>
          <div className={styles.dresspage__container_card}><Image src="../../Assets/Image/DressImage/BlackDressImage.png"/></div>
        </div>
      </div>
    </div>
  );
